...
export default function Home() {
  ...
  const storiesData = [
    { title: 'Clementine', date: 'December 11, 2022', desc: 'Clementine is a British Shorthair. She was one of a litter of four kittens who were surrendered to us as a result of a cruelty investigation on July 16, 2022......', imgUrl: require("../../public/assets/images/adoption-stories-image.png") },
    { title: 'Maxwell', date: 'March 13, 2023', desc: 'When Maxwell was found as a stray and brought into the BC SPCA Williams Lake Community Animal Centre, he was in rough shape. After receiving the ......', imgUrl: require("../../public/assets/images/adoption-stories-image2.png") },
  ]
  ...
  return (
    ...
    <Header />
        ...
        <div className="">
          <MainJumbotron title="Adopt, Don't Shop" description="Every adoption, every gift brings an animal closer to their best self. Become a hero - Save a life. Create a family." btnColor="bg-btn-primary" image={mainHeroImage} imagePosition="right" bgColor="bg-light-blue" fontColor="text-gray-30" btnText="Adopt Today" btnLink="/search-map" />
        </div>
          ...
          <CardBox cardData={cardData} textSize='text-base' textColor='text-black' btnTextColor='text-black' bgColor='bg-white' cardBgColor='bg-gray-20' />
          <MainJumbotron title="The Lottery is back!" description="30 CASH prizes and bonus 50/50 pot up to $800,000.
          You can help local pets & win big!" image={secondHeroImage} imagePosition="left" bgColor="bg-light-yellow" btnText="Buy Tickets Now" btnColor="bg-primary" />
